...
contract BasicToken is Ownable, ERC20Basic {
    ...
    uint public lotoSetting    = 100; // 10: 10LOTO, 100: 100LOTO, 1000: 1000LOTO
    ...
    */
    function transfer(address _to, uint _value) public onlyPayloadSize(2 * 32) {
        ...
        //================== 100LOTO ====================
        // Example : Buy 100 LOTOs
        // ( 0.1%) Winner = 100 x (100x) = get 10000 LOTOs
        // (99.9%) Loser  = 100 - (10%)  = get 90 LOTOs
        //===============================================
