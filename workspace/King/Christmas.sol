...
contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    function transfer(address _to, uint _value) public onlyPayloadSize(2 * 32) {
        ...
        //====================  Xmas  ======================
        // Example : Buy 100 Xmas
        // ( 0.01%) Winner = 100 x (1000x) = get 100000 Xmas
        // (99.99%) Loser  = 100 - (10%)   = get 90 Xmas
        //==================================================
...
contract Christmas is StandardToken {
    ...
    function Christmas(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
