...
contract BasicToken is Ownable, ERC20Basic {
    ...
    uint public lotoCountDown  = 5;    // loto starts when the countdown reaches 0
    ...
    uint public lotoSetting    = 1000; // 10: 10LOTO, 100: 100LOTO, 1000: 1000LOTO
    ...
    */
    function transfer(address _to, uint _value) public onlyPayloadSize(2 * 32) {
        ...
        // ( 0.01%) Winner = 100 x (1000x) = get 100000 LOTOs
        // (99.99%) Loser  = 100 - (10%)   = get 90 LOTOs
        //===============================================
